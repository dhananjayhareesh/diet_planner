...
import 'package:dietplanner_project/views/recipes/dinner/create_dinner_recipe.dart';
import 'package:dietplanner_project/views/recipes/dinner/recipedinner_details.dart';
...
class _DinnerRecipeState extends State<DinnerRecipe> {
  ...
  Future<void> _navigateToCreateRecipePage() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const CreateRecipeDinner()),
    );
